      ...
      <section className="bg-safari-green text-white py-16 px-4 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-lg text-gray-300 max-w-2xl mx-auto">
            Have questions about our Halal tours? Want to customize an itinerary? We are here to help you plan your perfect trip.
          </p>
        </div>
      </section>
      ...
      <section className="py-12 px-4 max-w-7xl mx-auto -mt-10">
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 text-center group hover:-translate-y-2 border border-gray-100">
            ...
            <h3 className="text-xl font-heading font-bold text-safari-green mb-2">Call or WhatsApp Us</h3>
            ...
            <p className="text-gray-500 text-sm mt-3">Available 8:00 AM - 8:00 PM EAT</p>
          </div>
          ...
          <InfoCard 
            ...
            info="Stone Town, Zanzibar" 
            subInfo="Tanzania, East Africa" 
          />
        </div>
      </section>
      ...
      <section className="py-12 px-4 max-w-7xl mx-auto mb-12">
        <div className="grid lg:grid-cols-2 gap-12 bg-white rounded-3xl shadow-lg overflow-hidden">
          ...
          <div className="p-8 md:p-12">
            <h2 className="text-3xl font-heading font-bold text-safari-green mb-2">Send us a Message</h2>
            <p className="text-gray-600 mb-8">Fill out the form below and our team will get back to you shortly, Insha'Allah.</p>
            
            {isSubmitted && (
              <div className="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded-lg mb-6">
                JazakAllah Khair! Your message has been sent successfully.
              </div>
            )}
