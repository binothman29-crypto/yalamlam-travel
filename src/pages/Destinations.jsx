  ...
  const destinations = [
    {
      ...
      tagline: "Spice Island & Beach Paradise",
      image: "https://images.unsplash.com/photo-1590523741831-ab7e8b8f9c7f?q=80&w=1000&auto=format&fit=crop",
      description: "Relax on pristine white sands, explore the historic Stone Town, and enjoy world-class Halal seafood.",
      tours: 12
    },
    {
      id: 2,
      ...
      description: "Witness millions of wildebeest and the Big Five in their natural, untamed habitat.",
      tours: 8
    },
    {
      id: 3,
      name: "Ngorongoro Crater",
      tagline: "The Garden of Eden",
      image: "https://images.unsplash.com/photo-1534177616072-ef7dc120449d?q=80&w=1000&auto=format&fit=crop",
      description: "Descend into the world's largest intact volcanic caldera, teeming with wildlife year-round.",
      tours: 6
    },
    {
      id: 4,
      ...
      description: "Challenge yourself with a guided trek to the highest peak in Africa, with Halal mountain cuisine.",
      tours: 4
    },
    {
      id: 5,
      ...
      description: "Famous for its massive elephant herds and ancient baobab trees. A peaceful, less-crowded safari.",
      tours: 5
    },
    {
      id: 6,
      name: "Lake Manyara",
      tagline: "Tree Lions & Flamingos",
      image: "https://images.unsplash.com/photo-1549366021-9f761d040a94?q=80&w=1000&auto=format&fit=crop",
      description: "A stunning groundwater forest home to tree-climbing lions and massive flocks of pink flamingos.",
      tours: 4
    }
  ];
    ...
    <div className="min-h-screen bg-safari-sand">
      ...
      <section className="relative h-[50vh] flex items-center justify-center bg-cover bg-center" 
        ...
        <div className="relative z-10 text-center text-white px-4">
          <h1 className="text-4xl md:text-6xl font-heading font-bold mb-4">Discover Tanzania</h1>
          <p className="text-lg md:text-xl text-gray-200 max-w-2xl mx-auto">From the snow-capped peaks of Kilimanjaro to the turquoise waters of the Indian Ocean.</p>
        </div>
      </section>
            ...
            <div key={dest.id} className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-500 group cursor-pointer">
              ...
              <div className="p-6">
                ...
                <div className="flex justify-between items-center pt-4 border-t border-gray-100">
                  <span className="text-sm font-semibold text-safari-teal">{dest.tours} Tours Available</span>
